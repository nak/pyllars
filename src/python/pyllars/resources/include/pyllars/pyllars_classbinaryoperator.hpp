...
namespace __pyllars_internal {
    ...
    BinaryOp<name, kwlist, ReturnType(core_type<T>::type::*)(ArgType), method>::addBinaryOperator() {
        PythonClassWrapper<T>::_binaryOperators()[name] = (binaryfunc) MethodContainer<kwlist,  ReturnType(core_type<T>::type::*)(ArgType), method>::callAsBinaryFunc;
    }
    ...
    BinaryOp<name, kwlist, ReturnType(core_type<T>::type::*)(ArgType) const, method>::addBinaryOperator() {
        PythonClassWrapper<T>::_binaryOperatorsConst()[name] = (binaryfunc) MethodContainer< kwlist,  ReturnType(core_type<T>::type::*)(ArgType) const,
