...
namespace pyllars_internal {
    ...
    template
    struct DLLEXPORT Pointers<volatile bool *>;

    template
    struct DLLEXPORT Pointers<volatile char *>;

    template
    struct DLLEXPORT Pointers<volatile signed char *>;

    template
    struct DLLEXPORT Pointers<volatile short *>;

    template
    struct DLLEXPORT Pointers<volatile int *>;

    template
    struct DLLEXPORT Pointers<volatile long *>;

    template
    struct DLLEXPORT Pointers<volatile long long *>;

    template
    struct DLLEXPORT Pointers<volatile unsigned char *>;


    template
    struct DLLEXPORT Pointers<volatile unsigned short *>;

    template
    struct DLLEXPORT Pointers<volatile unsigned int *>;

    template
    struct DLLEXPORT Pointers<volatile unsigned long *>;

    template
    struct DLLEXPORT Pointers<volatile unsigned long long *>;
