...
namespace __pyllars_internal{
    ...
    class CObjectConversionHelper< C_type , is_array,  is_complete, PtrWrapper,
                                  typename std::enable_if< std::is_class<C_type>::value ||
                                                          (std::is_reference<C_type>::value &&
                                                           ...
                                                           (std::is_pointer<C_type>::value && std::is_convertible<C_type, const void*>::value)>::type>{
    public:
    ...
    class CObjectConversionHelper<T, is_array, is_complete, ClassWrapper, typename std::enable_if< std::is_integral<T>::value || std::is_enum<T>::value ||
     ...
     **/
    template<typename T, bool is_array, bool is_complete, typename ClassWrapper>
    class CObjectConversionHelper<T, is_array, is_complete, ClassWrapper, typename std::enable_if< std::is_floating_point<T>::value ||
     ...
     public:
        ...
        static smart_ptr< T[size], is_array> toCObject( PyObject& pyobj){
             ...
             if (PyObject_TypeCheck(&pyobj, &(PtrWrapper::Type))){
                ...
                return smart_ptr<T_array, is_array>(reinterpret_cast<ClassWrapper* >(&pyobj)->template get_CObject<T_array>(), false);
       ...
       static smart_ptr< T_array, false> toCObject( PyObject& pyobj){
         ...
         if (PyObject_TypeCheck(&pyobj, &(PtrWrapper::Type))){
               ...
               return smart_ptr< T_array, false>(val, true);
                ...
                return smart_ptr<T_array, false>(reinterpret_cast<ClassWrapper* >(&pyobj)->template get_CObject<T_array>(), false);
            }else {
                throw "Conversiont o C stgring from non-string Python object!";
            }
    ...
    private:
        ...
        public:
            ...
            static PyObject* toPyObject( T & var, const bool asArgument ){
                ...
                PyObject* pyobj = PyObject_Call(  (PyObject*)&ClassWrapper::Type,
                                                  emptyTuple, kw);
                Py_DECREF(kw);
        ...
        public:
          ...
          static PyObject* toPyObject(  T & var, const bool asArgument ){
            ...
            reinterpret_cast<ClassWrapper*>(pyobj)->set_contents( asArgument?&var:new T_NoRef(var), !asArgument);
            return pyobj;
          onerror:
            PyErr_Print();
            return Py_None;
       ...
       /**
         ...
         **/
        template<typename T, bool is_complete, typename ClassWrapper, const ssize_t max>
          class PyObjectConversionHelper<T[], is_complete, ClassWrapper, max, void>{
        public:
          typedef typename std::remove_reference<T>::type T_NoRef;
          typedef T T_array[];
          static PyObject* toPyObject(  T* const & var, const bool asArgument ){
            ...
            //create the object of the desired type and do some checks
            PyObject* emptyTuple = PyTuple_New(0);
            PyObject* pyobj = PyObject_Call(  (PyObject*)&ClassWrapper::Type, emptyTuple, nullptr);
            Py_DECREF(emptyTuple);
         ...
         **/
        template<bool is_complete, typename ClassWrapper, const size_t size, const ssize_t max>
        class PyObjectConversionHelper<const char[size], is_complete, ClassWrapper, max,void>{
        public:
          ...
          static PyObject* toPyObject(  T_array& var, const bool asArgument ){
            ...
            }
            {
              ...
              reinterpret_cast<ClassWrapper*>(pyobj)->set_contents( (void**)(asArgument?&var:var_), !asArgument);
            }
            return pyobj;
          onerror:
            PyErr_Print();
         ...
         **/
        template<typename T, bool is_complete, typename ClassWrapper, const ssize_t max>
        class PyObjectConversionHelper<T, is_complete, ClassWrapper, max, typename  std::enable_if< std::is_integral<T>::value || std::is_enum<T>::value >::type >{
        public:
         ...
         **/
        template<typename T, bool is_complete, typename ClassWrapper, const ssize_t max>
        class PyObjectConversionHelper<T, is_complete, ClassWrapper, max, typename  std::enable_if< std::is_const<T>::value && std::is_reference<T>::value &&
          ( std::is_integral<typename std::remove_reference<T>::type>::value ||
            std::is_enum<typename std::remove_reference<T>::type>::value
             )>::type >{
        public:
